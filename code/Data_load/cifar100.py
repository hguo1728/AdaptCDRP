...
class cifar100_dataset(Data.Dataset):
    def __init__(self, train=True, 
        ...
        if args.error_rate_type=='high' or args.error_rate_type=='mid' or args.error_rate_type=='low':
            ...
            logger.info('Cifar100: Getting real annotations......')
            annotations = np.load('../data/cifar_n/annotations_cifar100n.npy')
            annotations = annotations.astype(int)
            annotations = annotations.reshape((original_images.shape[0], 1))
            noisy_label = np.load('../data/cifar_n/annotations_cifar100n.npy')
